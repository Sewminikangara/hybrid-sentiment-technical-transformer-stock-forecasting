...
if __name__ == "__main__":
    logger.info("Early Fusion Hybrid Transformer")
    logger.info("Combines technical and sentiment features at input level")
    logger.info("\nModel Architecture:")
    logger.info("  Input: Technical + Sentiment (concatenated)")
    logger.info("  → Shared Transformer Encoder")
