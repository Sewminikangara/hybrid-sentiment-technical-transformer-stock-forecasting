...
if __name__ == "__main__":
    logger.info("Late Fusion Hybrid Transformer")
    logger.info("Separate processing branches for technical and sentiment")
    logger.info("\nModel Architecture:")
    logger.info("  Technical → Transformer → Representation A")
    logger.info("  Sentiment → Transformer → Representation B")
    logger.info("  [A + B] → Fusion → Prediction")
